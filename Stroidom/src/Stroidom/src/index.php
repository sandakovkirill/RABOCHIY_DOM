...
<head>
    ...
    <script src="js/list_dropdown.js"></script>
                ...
                <div class="header_top">
                    <nav class="menu">
                        ...
                        <ul class="navbar">
                            ...
                            <li class="navbar__item"> <img src="icons/line_icon.svg" alt=""></li>
            ...
            <div class="header_bottom">
                ...
                <div class="picture-section">
                    <div class="img-slider">
                        <div class="slide-image"> <img src="img/img-slider-1.png" alt="">
                        </div>
                    </div>
                    <div class="picture-section__images">
                        <div class="picture-section__image-top"> <img src="img/image_section_top.png" alt=""></div>
                        <div class="picture-section__image-bottom"> <img src="img/image_section_bottom.png" alt=""></div>
                    </div>
                </div>             
            </div>
            </div>
